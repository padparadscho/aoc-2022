...
To be able to communicate with the Elves, the device needs to lock on to _their signal_. The signal is a series of seemingly-random characters that the device receives one at a time.
