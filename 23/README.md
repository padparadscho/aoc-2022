...
_"...but this volcano has been dormant for months. Without ash, the fruit can't grow!"_

You look up to see a massive, snow-capped mountain towering above you.

_"It's not like there are other active volcanoes here; we've looked everywhere."_

_"But our scanners show active magma flows; clearly it's going somewhere."_

They finally notice you at the edge of the grove, your pack almost overflowing from the random **star** fruit you've been collecting. Behind you, elephants and monkeys explore the grove, looking concerned. Then, the Elves recognize the ash cloud slowly spreading above your recent detour.

_"Why do you--" "How is--" "Did you just--"_

Before any of them can form a complete question, another Elf speaks up: _"Okay, new plan. We have almost enough fruit already, and ash from the plume should spread here eventually. If we quickly plant new seedlings now, we can still make it to the extraction point. Spread out!"_
...
> **SOLUTION**: It contains `4034` empty ground tiles.
