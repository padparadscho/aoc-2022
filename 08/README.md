...
> **SOLUTION**: There are `1715` trees visible.
...
A tree's scenic score is found by _multiplying together_ its viewing distance in each of the four directions. For this tree, this is `4` (found by multiplying `1 * 1 * 2 * 2`).
...
> **SOLUTION**: The highest scenic score is `374400`.
